...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'myrestaurants_restaurantreview', (
            (u'review_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['myrestaurants.Review'], unique=True, primary_key=True)),
            ('restaurant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myrestaurants.Restaurant'])),
        ))
        db.send_create_signal(u'myrestaurants', ['RestaurantReview'])


    def backwards(self, orm):
        # Deleting model 'RestaurantReview'
        db.delete_table(u'myrestaurants_restaurantreview')
