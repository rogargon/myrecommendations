...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'myrestaurants_review', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Review.date'
        db.alter_column(u'myrestaurants_review', 'date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Review.user'
        db.alter_column(u'myrestaurants_review', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Review.comment'
        raise RuntimeError("Cannot reverse this migration. 'Review.comment' and its values cannot be restored.")

        # Changing field 'Review.date'
        db.alter_column(u'myrestaurants_review', 'date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Review.user'
        db.alter_column(u'myrestaurants_review', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'myrestaurants.dish': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['myrestaurants.Restaurant']", 'null': 'True'}),
        ...
        u'myrestaurants.restaurantreview': {
            'Meta': {'object_name': 'RestaurantReview', '_ormbases': [u'myrestaurants.Review']},
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['myrestaurants.Restaurant']"}),
            u'review_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['myrestaurants.Review']", 'unique': 'True', 'primary_key': 'True'})
        },
